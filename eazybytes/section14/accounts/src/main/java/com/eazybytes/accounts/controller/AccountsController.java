...
public class AccountsController {
    ...
    @Operation(
            ...
            description = "REST API to get  Customer & Account inside Eazy Bank"
    )
    @ApiResponse(
            responseCode = "200",
    ...
    public ResponseEntity<String> getBuildInfo() throws TimeoutException {
        ...
        //throw new TimeoutException("Exception occurred"); // For retry pattern demo
        return ResponseEntity
                .status(HttpStatus.OK)
                .body(buildVersion);
    }
    ...
    @Operation(
            ...
            description = "Get java version information that is deployed into account microservice"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
    ...
    @Operation(
            ...
            description = "Get contact information that can be reached in case of any issues"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
