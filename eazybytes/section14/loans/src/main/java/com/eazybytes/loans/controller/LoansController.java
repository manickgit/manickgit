...
public class LoansController {
    ...
    @Operation(
            summary = "Get contact information for Loans MS",
            description = "Contact information that can be reached  in case of any issues"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
    ...
    public ResponseEntity<LoansContactInfo> getContactInfo() {
        ...
        //throw new RuntimeException("Exception occurred. To test retry pattern");
        return ResponseEntity
                .status(HttpStatus.OK)
